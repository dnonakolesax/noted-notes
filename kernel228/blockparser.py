...
signatures = {}
try:
    with open("/tmp/kernel228/signatures.json", "r") as infile:
...
def parse(filename):
    ...
    filename = "/tmp/kernel228/" + filename
    needFunc = False
    figureStack = []
    ...
    with open("/tmp/kernel228/base") as f:
        for line in f:
...
with open("/tmp/kernel228/signatures.json", "w") as outfile:
